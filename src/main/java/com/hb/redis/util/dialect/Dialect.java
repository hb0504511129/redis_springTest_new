package com.hb.redis.util.dialect;
...
public class Dialect implements IDialect {
	 ...
	 * 
	 * @see
	 * com.harmony.framework.dao.mybatis.dialect.IDialect#supportsLimitOffset()
	 */
	 ...
	 * 
	 * @see
	 * com.harmony.framework.dao.mybatis.dialect.IDialect#getLimitString(java
	 * .lang.String, int, int)
	 */
