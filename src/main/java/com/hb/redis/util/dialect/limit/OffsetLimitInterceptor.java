package com.hb.redis.util.dialect.limit;
...
import com.hb.redis.util.dialect.IDialect;
import com.hb.redis.util.dialect.IDialectManager;
...
public class OffsetLimitInterceptor implements Interceptor {
	...
	private MappedStatement copyFromMappedStatement(MappedStatement ms,
		...
		builder.keyProperty(ms.getId());// ms.getId()替换ms.getKeyProperty()
