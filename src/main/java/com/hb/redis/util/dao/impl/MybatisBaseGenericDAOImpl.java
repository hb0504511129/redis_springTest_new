package com.hb.redis.util.dao.impl;
...
import com.hb.redis.util.bean.BeanMapUtil;
import com.hb.redis.util.exception.BaseDaoException;
import com.hb.redis.util.page.GenericDefaultPage;
import com.hb.redis.util.page.IGenericPage;
import com.hb.redis.util.reflect.ReflectGeneric;
...
public abstract class MybatisBaseGenericDAOImpl<T, ID extends Serializable>
		extends SqlSessionDaoSupport implements
		com.hb.redis.util.dao.IBaseGenericDAO<T, ID> {
